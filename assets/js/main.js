      ...
      if (namep != '') {
        ...
        $.ajax({
          ...
          success: function() {
            ...
            $('#cp-msg').fadeIn().html('<div class="alert alert-success"><strong>Succès!</strong>Le courriel a été envoyé avec succès.</div>');
            setTimeout(function() {
              $('#cp-msg').fadeOut('slow');
            }, 4000);
          }
        ...
        if (name != '' && email != '' && msg != '') {
          ...
          $.ajax({
            ...
            success: function() {
              ...
              $('#cf-msg').fadeIn().html('<div class="alert alert-success"><strong>Succès!</strong>Le courriel a été envoyé avec succès.</div>');
